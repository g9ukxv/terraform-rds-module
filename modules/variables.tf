...
variable "parameter_group_name" {
  description = "Name of the existing DB parameter group to attach to the instance. Required for postgres workspaces; mysql workspaces use a Terraform-managed group."
  type        = string
  default     = ""
}
