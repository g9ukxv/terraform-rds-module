...
locals {
  # Parameter group is passed explicitly via var.parameter_group_name in each tfvars file.
  # For MySQL workspaces the Terraform-managed group name is used as the default fallback.
